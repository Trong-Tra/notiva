        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            {dayTasks.length === 0 ? (
              ...
              <FlatList data={dayTasks} keyExtractor={(item) => item.id} renderItem={renderTask} contentContainerStyle={styles.taskList} />
            )}
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, maxHeight: '70%', minHeight: 200 },
