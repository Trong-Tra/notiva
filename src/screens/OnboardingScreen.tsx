          ...
          {step === 1 && (
            <View style={styles.step}>
              ...
              <TextInput
                ...
                maxLength={30}
              />
              <TouchableOpacity style={[styles.button, !spaceName.trim() && styles.buttonDisabled]} onPress={handleSpaceSubmit} disabled={!spaceName.trim()}>
            ...
            <View style={styles.step}>
              ...
              <View style={styles.colorRow}>
                {boardBackgroundColors.map((color) => (
                  <TouchableOpacity key={color} style={[styles.colorDot, { backgroundColor: color }, boardColor === color && styles.colorDotActive]} onPress={() => setBoardColor(color)} />
                ))}
              </View>
              <TouchableOpacity style={[styles.button, !boardTitle.trim() && styles.buttonDisabled]} onPress={handleBoardSubmit} disabled={!boardTitle.trim()}>
                <Text style={styles.buttonText}>Continue</Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          {step === 3 && (
            <View style={styles.step}>
              ...
              <TouchableOpacity style={styles.button} onPress={handleTaskSubmit}>
                <Text style={styles.buttonText}>{taskTitle.trim() ? 'Get Started' : 'Skip & Get Started'}</Text>
              </TouchableOpacity>
            </View>
          )}
        </ScrollView>
