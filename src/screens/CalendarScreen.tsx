...
const styles = StyleSheet.create({
  ...
  calendar: { marginHorizontal: 10, marginTop: 10, borderRadius: 12, backgroundColor: '#fff', paddingBottom: 10 },
  ...
  modalContent: { backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, maxHeight: '75%', minHeight: 200 },
  ...
  addForm: { backgroundColor: '#F9FAFB', borderRadius: 12, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: '#F0F0F0' },
  addInput: { backgroundColor: '#fff', borderRadius: 10, borderWidth: 1, borderColor: '#E5E7EB', padding: 12, fontSize: 16, color: colors.textPrimary, marginBottom: 12 },
  selectorRow: { flexDirection: 'row', gap: 10, marginBottom: 12 },
  selector: { flex: 1, backgroundColor: '#fff', borderRadius: 10, borderWidth: 1, borderColor: '#E5E7EB', padding: 10 },
  ...
  addConfirmDisabled: { backgroundColor: '#D1D5DB' },
  addConfirmText: { fontSize: 14, fontWeight: '600', color: '#fff' },
  emptyText: { textAlign: 'center', color: colors.textMuted, fontSize: 15, marginTop: 20 },
  taskList: { paddingBottom: 20 },
  taskCard: { backgroundColor: '#F9FAFB', padding: 14, borderRadius: 10, marginBottom: 10, borderWidth: 1, borderColor: '#F0F0F0' },
